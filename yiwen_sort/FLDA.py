...
# DATAS=np.delete(DATAS,4056-start_num,0)
# DATAS=np.delete(DATAS,4135-start_num,0)
# DATAS=np.delete(DATAS,4136-start_num,0)
# DATAS=np.delete(DATAS,5004-start_num,0)
...
# print(xtrain_face)
print('用训练后的表情分类LDA模型降维后的图像测试数据：',xtest_face,xtest_face.shape)